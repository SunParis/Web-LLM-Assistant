...
For detailed side panel architecture and extension points, see [SIDEPANEL_ARCHITECTURE.md](https://github.com/SunParis/Web-LLM-Assistant/blob/main/docs/SIDEPANEL_ARCHITECTURE.md).
